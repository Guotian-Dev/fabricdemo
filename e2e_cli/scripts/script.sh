...
installChaincode 0
echo "Install chaincode on peer2..."
installChaincode 2
...
#Invoke on chaincode on Org1
echo "Sending invoke transaction on peer0..."
chaincodeInvoke 0

## Install chaincode on Peer3/Org2
echo "Installing chaincode on peer3..."
installChaincode 3

#Query on chaincode on Peer3/Org2, check if the result is 90
echo "Querying chaincode on peer3..."
chaincodeQuery 3 90
